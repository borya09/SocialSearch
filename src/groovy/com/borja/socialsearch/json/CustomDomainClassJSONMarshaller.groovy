package com.borja.socialsearch.json
...
public class CustomDomainClassJSONMarshaller implements ObjectMarshaller<JSON> {
   ...
   // private boolean includeVersion = false
    ...
    public CustomDomainClassJSONMarshaller(GrailsApplication application, String jsonPropertyGroup = "") {
        this(new DefaultProxyHandler(), application, jsonPropertyGroup)
    }

    public CustomDomainClassJSONMarshaller(ProxyHandler proxyHandler, GrailsApplication application, String jsonPropertyGroup) {
 ...
 /*   public boolean isIncludeVersion() {
    ...
    public void marshalObject(Object value, JSON json) throws ConverterException {
        ...
        */
        ...
        def properties = getPropertiesToBeIncluded(domainClass)
                ...
                if (referenceObject == null) {
                    ...
                    if (referencedDomainClass == null || property.isEmbedded() || GrailsClassUtils.isJdk5Enum(property.getType())) {
                        ...
                        if (referenceObject instanceof Collection) {
                            ...
                            writer.array()
                            for (Object el : o) {
                                //Print all the properties of the child
                                json.convertAnother(el)
